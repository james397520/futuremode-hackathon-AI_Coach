...
export const MOCK_TRANSCRIPT: TranscriptTurn[] = [
  {
    ...
    session_id: DEMO_SESSION_ID,
    speaker: 'system',
    text: '模擬開始 · 情境：週三晚間視訊約訪 · Persona：陳先生（38 歲工程師）· Mode：Training',
    timestamp_ms: 0,
  },
  {
    id: 'trn_02',
  ...
  },
  {
    ...
    session_id: DEMO_SESSION_ID,
    speaker: 'knowledge',
    text: '引用 Product SOP v3 §3.3：團保保額通常為年薪之一至二倍，且不含重大疾病一次金。',
    timestamp_ms: 42_100,
  ...
  },
  {
    ...
    session_id: DEMO_SESSION_ID,
    speaker: 'system',
    text: '模擬結束 · 24 turns · 14 分 12 秒 · 評估中',
...
export const DEMO_STATE_TIMELINE: StateTimelinePoint[] = [
  { at_ms: 4_000, turn_id: 'trn_02', emotion: 'skeptical', phase: 'opening', trust: 38, resistance: 68, marker: 'state_change', note: 'Opening objection' },
  { at_ms: 13_200, turn_id: 'trn_03', emotion: 'skeptical', phase: 'opening', trust: 34, resistance: 74, marker: 'missed_signal', note: 'Pitched before discovery' },
  { at_ms: 31_800, turn_id: 'trn_06', emotion: 'curious', phase: 'needs_discovery', trust: 46, resistance: 62, marker: 'key_response', note: 'Turned to the gap numbers' },
  { at_ms: 58_600, turn_id: 'trn_09', emotion: 'interested', phase: 'presentation', trust: 63, resistance: 48, marker: 'key_response', note: 'Quantified the coverage gap' },
  { at_ms: 71_200, turn_id: 'trn_10', emotion: 'interested', phase: 'presentation', trust: 66, resistance: 46, marker: 'state_change', note: 'Hidden need surfaced' },
  { at_ms: 79_900, turn_id: 'trn_11', emotion: 'skeptical', phase: 'presentation', trust: 58, resistance: 52, marker: 'missed_signal', note: 'Emotional signal skipped' },
  { at_ms: 121_800, turn_id: 'trn_16', emotion: 'curious', phase: 'objection_handling', trust: 60, resistance: 50, marker: 'compliance_warning', note: 'Implied guaranteed payout' },
  { at_ms: 136_400, turn_id: 'trn_18', emotion: 'reassured', phase: 'objection_handling', trust: 68, resistance: 44, marker: 'key_response', note: 'Self-corrected with the clause' },
  { at_ms: 162_000, turn_id: 'trn_21', emotion: 'ready', phase: 'ended', trust: 74, resistance: 41, marker: 'state_change', note: 'Agreed to a follow-up' },
];
...
export const MOCK_COACH_INSIGHTS: CoachInsight[] = [
  {
    ...
    timestamp_ms: 13_200,
    kind: 'missed_signal',
    title: 'Necessity question answered with a product pitch',
  ...
  },
  {
    ...
    timestamp_ms: 80_400,
    kind: 'missed_signal',
    title: 'Emotional signal skipped',
  ...
  },
  {
    ...
    timestamp_ms: 116_300,
    kind: 'next_strategy',
    title: 'Guarantee probe incoming',
  ...
  },
  {
    ...
    timestamp_ms: 166_000,
    kind: 'post_session',
    title: 'Strongest turn was the gap calculation',
    body:
  ...
  },
  {
    ...
    kind: 'post_session',
    title: 'Recover faster after a compliance slip',

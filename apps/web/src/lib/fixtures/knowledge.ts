...
export const MOCK_KNOWLEDGE_BASES: KnowledgeBase[] = [
  ...
  },
  {
    id: 'kb_playbook',
    ...SCOPE,
    name: 'Top Performer Playbook',
    description: '由 Knowledge Mining 產出的 golden phrase / objection pattern，需人工覆核後發布。',
...
export const MOCK_DOCUMENTS: KnowledgeDocument[] = [
  ...
  },
  {
    ...
    ...SCOPE,
    knowledge_base_id: 'kb_product_sop',
    filename: '2026-Premium-Bands.xlsx.csv',
    source_kind: 'csv',
    size_bytes: 264_120,
    state: 'ready',
    progress: 100,
  ...
  },
  {
    ...
    ...SCOPE,
    knowledge_base_id: 'kb_product_sop',
    filename: 'Group-vs-Personal-Cover.pptx',
    source_kind: 'pptx',
  ...
  },
  {
    ...
    ...SCOPE,
    knowledge_base_id: 'kb_product_sop',
    filename: 'Claims-Case-Archive-scanned.pdf',
    source_kind: 'pdf',
    ...
    active_version: 1,
    failure_reason:
      'OCR confidence below threshold on 27 pages (handwritten annotations). Re-run with the high-accuracy OCR profile or upload a clean scan.',
  ...
  },
  {
    ...
    ...SCOPE,
    knowledge_base_id: 'kb_compliance',
    filename: 'Regulator-Circular-2026-04.pdf',
    source_kind: 'pdf',
    size_bytes: 962_000,
    state: 'indexing',
    progress: 88,
  ...
  },
  {
    ...
    filename: 'Top-Sales-Transcripts-Q1.csv',
    source_kind: 'csv',
...
export const DOCUMENT_PIPELINE_STEPS = [
  { state: 'validating', label: 'Validation' },
  { state: 'parsing', label: 'Text extraction' },
  { state: 'chunking', label: 'Structure detection & chunking' },
  { state: 'embedding', label: 'Embedding' },
  { state: 'indexing', label: 'Indexing' },
  { state: 'ready', label: 'Ready for retrieval' },
] as const;
...
export const MOCK_CHUNKS: Chunk[] = [
  ...
  },
  {
    ...
    index: 1310,
    text:
      '（Top performer, anonymised）「我不是要你多買一張保單，是想確認萬一你三個月不能工作，房貸誰付。我們先把這個數字算出來，再談要不要調整。」',
    token_count: 88,
    section: 'Objection: already insured',
...
export const MOCK_CITATIONS: Citation[] = [
  ...
  },
  {
    chunk_id: 'chk_1310',
    document_id: 'doc_top_transcripts',
    document_name: 'Top Sales Transcripts Q1',
    document_version: 1,
    section: 'Objection: already insured',
    similarity: 0.72,
    rerank_score: 0.41,
...
export const MINING_KIND_LABEL: Record<MiningKind, string> = {
  golden_phrase: 'Golden phrase',
  objection_pattern: 'Objection pattern',
  best_practice: 'Best practice',
  anti_pattern: 'Anti-pattern',
  rubric_evidence: 'Suggested rubric evidence',
...
export const MOCK_MINING_CANDIDATES: MiningCandidate[] = [
  {
    ...
    source_label: 'Top performer — Taipei North',
    source_session_ref: 'session #1187 (anonymised)',
    anonymised: true,
    confidence: 0.93,
    occurrences: 14,
    suggested_target: 'Top Performer Playbook → Objection: already insured',
  ...
  },
  {
    ...
    source_label: 'Aggregated across 214 sessions',
    source_session_ref: 'pattern cluster #12',
    anonymised: true,
    confidence: 0.88,
    occurrences: 214,
    suggested_target: 'Persona 陳先生 → Objections',
    status: 'pending_review',
  },
  {
    id: 'mine_003',
    ...
    source_label: 'Flagged session — Taichung',
    source_session_ref: 'session #1204',
    anonymised: true,
    confidence: 0.97,
    occurrences: 6,
    suggested_target: 'Compliance Policy 2026 → Forbidden phrases',
    status: 'pending_review',
  },
  {
    id: 'mine_004',
    ...
    source_label: 'Coaching notes + session analytics',
    source_session_ref: 'analysis 2026-Q1',
    anonymised: true,
    confidence: 0.81,
    occurrences: 96,
    suggested_target: 'Rubric rub_life_core → Needs discovery evidence',
    status: 'approved',
  },
  {
    id: 'mine_005',
    ...
    title: '客戶親屬剛因病離世',
    extract:
      'FAQ escalation log 中出現 11 次「客戶剛失去親人且情緒激動」的情境，現有 scenario 未覆蓋。',
    source_label: 'FAQ escalation logs',
    source_session_ref: 'escalation cluster #4',
    anonymised: true,
    confidence: 0.76,
    occurrences: 11,
    suggested_target: 'New scenario draft',
    status: 'pending_review',
  },
  {
    id: 'mine_006',
    kind: 'rubric_evidence',
    title: 'Empathy — 承接情緒的具體句型',
    extract: '「你剛剛提到壓力很大，是工作上的還是家裡的？」— 出現此類回應時 empathy 分數平均高 18 分。',
    source_label: 'Manager coaching notes',
    source_session_ref: 'notes 2026-02',
    anonymised: true,
    confidence: 0.84,
    occurrences: 38,
    suggested_target: 'Rubric rub_life_core → Empathy required evidence',
    status: 'rejected',
  },
];
